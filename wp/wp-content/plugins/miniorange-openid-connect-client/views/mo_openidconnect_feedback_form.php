...
function mo_openidconnect_client_display_feedback_form() {
...
?>
    ...
    <body>
    <div id="openidconnect_client_feedback_modal" class="mo_modal">
        <div class="mo_modal-content">
            <span class="mo_close">&times;</span>
            <h3>Tell us what happened? </h3>
            <form name="f" method="post" action="" id="mo_openidconnect_client_feedback">
                <input type="hidden" name="mo_openidconnect_client_feedback" value="true"/>
                <div>
            ...
            <form name="f" method="post" action="" id="mo_feedback_form_close">
                <input type="hidden" name="option" value="mo_openidconnect_client_skip_feedback"/>
            </form>
        </div>
    </div>
    <script>
        jQuery('a[aria-label="Deactivate OpenID Connect Login ( OpenID Connect Client)"]').click(function () {
            var mo_modal = document.getElementById('openidconnect_client_feedback_modal');
            ...
            jQuery('input:radio[name="deactivate_reason_radio"]').click(function () {
                ...
                if (reason === "Does not have the features I'm looking for") {
                    ...
                    query_feedback.attr("placeholder", "We will send you the Endpoints shortly, if you can tell us the name of your OpenID Connect Server/App?");
                }
